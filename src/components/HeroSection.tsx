...
const HeroSection = () => {
  ...
  return (
    <section className="relative overflow-hidden gradient-hero">
      ...
      <div className="absolute top-20 right-[10%] w-72 h-72 bg-mint-light rounded-full blur-3xl opacity-60 animate-float hidden md:block" style={{ animationDelay: '0s' }} />
      <div className="absolute bottom-0 left-[5%] w-96 h-96 bg-coral-light rounded-full blur-3xl opacity-40 animate-float hidden md:block" style={{ animationDelay: '1.5s' }} />
      
      <div className="container mx-auto px-4 pt-4 pb-10 md:pt-12 md:pb-20 lg:pt-20 lg:pb-28 relative">
        <div className="max-w-4xl mx-auto text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-full bg-mint-light text-primary text-xs md:text-sm font-medium mb-5 md:mb-8 animate-fade-in">
            <Sparkles className="w-3 h-3 md:w-4 md:h-4" />
            <span>AI-powered recommendations</span>
          </div>
          
          {/* Headline */}
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-[1.1] tracking-tight mb-4 md:mb-6 animate-fade-in" style={{ animationDelay: '0.1s' }}>
            Find the perfect{" "}
            <span className="text-gradient bg-gradient-to-r from-primary to-coral">credit card</span>{" "}
            for your lifestyle
          </h1>
          
          {/* Subheadline */}
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-6 md:mb-10 px-2 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            Compare <span className="font-semibold text-foreground">350+ cards</span> across rewards, cashback, and travel benefits. 
          ...
          {/* Search Bar */}
          <div className="max-w-[39.6rem] md:max-w-[41.58rem] mx-auto px-2 md:px-0">
                  ...
                  <div className="flex flex-row items-center bg-card border-b border-border">
                    <div className="flex items-center flex-1 px-5">
                      ...
                      <input
                        ...
                        onChange={(e) => setSearchQuery(e.target.value)}
                        placeholder="Tell me about your spending habits..."
                        className="flex-1 pl-14 pr-32 py-4 bg-transparent text-foreground placeholder:text-muted-foreground focus:outline-none min-w-0 input-search"
                      />
                    </div>
